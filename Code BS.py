...
while count<=997:
    ...
    #cv2.imshow('fg',fg)
    cv2.imwrite( r".\Background\frame%d.jpg" %count, bg );
    med = cv2.medianBlur(fg,3)
    cv2.imwrite( r".\Foreground\frame%d.jpg" %count, med );
    count += 1
...
count=0
while count<=997:
    img1=cv2.imread( r".\Foreground\frame%d.jpg" %count, 0)
    video1.write(img1)
...
count=0
while count<=997:
    img1=cv2.imread( r".\Background\frame%d.jpg" %count, 0)
    video2.write(img1)
